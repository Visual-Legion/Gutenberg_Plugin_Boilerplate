...
registerBlockType('vl-gpb/main', {
	...
	keywords: [
		__('VL Gutenberg Plugin Boilerplate '),
	...
	edit: function(props) {
     ...
     <RichText keepPlaceholderOnFocus="true" tagName="h1" className={ "vl_gpb__title" } label="Boilerplate title" help="Enter some text" value={ title } name="title"
	...
	save: function(props) {
		...
		return (
			<div className={ [props.className] }>
     <h1 className={ 'vl_gpb__title' }> { title } </h1>
   </div>
		)
